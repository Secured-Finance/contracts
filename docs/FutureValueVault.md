...
```solidity
function getFutureValue(address _account) public view returns (int256 futureValue, uint256 maturity)
```

### calculatePresentValue

```solidity
function calculatePresentValue(uint256 _futureValue, uint256 _maturity, uint256 _rate) external view returns (uint256)
```
