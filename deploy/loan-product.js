...
module.exports = async function ({ getNamedAccounts, deployments }) {
    ...
    const termStructureContract = await ethers.getContractAt("TermStructure", termStructure.address);

    const productResolver = await deployments.get("ProductAddressResolver")
    const productResolverContract = await ethers.getContractAt("ProductAddressResolver", productResolver.address);
...
module.exports.dependencies = ["Libraries", "ProductAddressResolver", "CurrencyController", "TermStructure", "CollateralAggregator", "Liquidations"]