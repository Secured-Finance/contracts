...
contract ProductAddressResolver is IProductAddressResolver {
    ...
    */
    function registerProduct(bytes4 _prefix, address _contract, address _controller) public override onlyOwner {
    ...
    */
    function registerProducts(bytes4[] calldata _prefixes, address[] calldata _contracts,  address[] calldata _controllers) public override onlyOwner {
