...
contract TermScheduleTest {
    ...
    function getTermSchedule(uint256 numDays, uint8 frequency) external view returns (uint256[] memory) {
        return TermSchedule.getTermSchedule(numDays, frequency);
    }

    function getNumPayments(uint256 numDays, uint8 frequency) external view returns (uint256) {
    ...
    function getGasCostOfGetTermSchedule(uint256 numDays, uint8 frequency) external view returns (uint256) {
    ...
    function getGasCostOfGetNumPayment(uint256 numDays, uint8 frequency) external view returns (uint256) {
        uint256 gasBefore = gasleft();
