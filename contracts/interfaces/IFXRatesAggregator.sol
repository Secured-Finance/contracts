...
interface IFXRatesAggregator {
    ...
    function linkPriceFeed(uint8 _ccy, address _priceFeedAddr, bool _isEthPriceFeed) external returns (bool);
    ...
    function convertBulkToETH(uint8 _ccy, uint256[] memory _amounts) external view returns (uint256[] memory);
}