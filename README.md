...
| create-fvm-proposal        | Create a custom proposal for FVM                         | `npx hardhat create-fvm-proposal --network filecoin-mainnet --contracts "CurrencyController,TokenVault" --functions "addCurrency,registerCurrency" --args '["0x...","18","0",["0x..."],["86400"]]\|["0x...","0x...","true"]'`          |
...
| verify-contracts-filfox    | Verify and register contracts on Filfox.                 | `npx hardhat verify-contracts-filfox --network filecoin-mainnet`                                                                                                                                                                       |
| verify-contracts-starboard | Verify and register contracts on Starboard.              | `npx hardhat verify-contracts-starboard --network filecoin-mainnet`                                                                                                                                                                    |
